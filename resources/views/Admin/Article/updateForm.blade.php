...
<div class="container">
    ...
    <form action="{{route('admin.update', $article->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input class="form-control" id="" name="dimension" type="number" value="{{old('dimension',$article->dimension)}}">
            @error("dimension")
            {{$message}}
        ...
        <fieldset class="form-group">
            ...
            <div class="form-check">
                <input class="form-check-input" type="checkbox" name="espace_verte" id="optionsRadios1" {{($article->espace_verte=='on') ? 'checked' : ""}}>
